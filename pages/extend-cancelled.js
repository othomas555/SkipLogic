...
export default function ExtendCancelledPage() {
  ...
  return (
    <main style={pageStyle}>
      <div style={cardStyle}>
        <h1 style={titleStyle}>Extension payment cancelled</h1>
        <div style={warnStyle}>
          No payment was taken. Your skip hire has not been extended.
        </div>
        <p style={textStyle}>
          Reference: <b>{jobId || "—"}</b>
        </p>
        <p style={textStyle}>
          You can go back and try again, or contact the office if you still need the skip for longer.
        </p>
